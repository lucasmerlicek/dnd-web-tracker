        ...
        {creating && (
          <UIPanel variant="fancy">
            ...
            <div className="space-y-3">
              ...
              <input type="text" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} onKeyDown={(e) => { if (e.key === "Enter" && form.title.trim()) createMarker(); }} placeholder="Title" className="w-full rounded border border-ff12-border-dim bg-dark-bg px-2 py-1 text-sm text-ff12-text" aria-label="Marker title" />
